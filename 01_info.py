...
print(f"PROJECT ADDRESS: {street_address}")
print(f"CITY: {city}")
print(f"STATE: {state}")
print(f"ZIP CODE: {zip_code}")
print(f"COUNTY: {county}")
print(f"APN: {apn}")
print(f"CLIENT NAME 1: {client_name_1}")
print(f"CLIENT EMAIL 1: {client_email_1}")
print(f"CLIENT NAME 2: {client_name_2}")
print(f"CLIENT EMAIL 2: {client_email_2}")
