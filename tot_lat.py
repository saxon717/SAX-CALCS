...
# =========================
# OPEN AND POPULATE — hidden until VERT reveals
# =========================
...
# Seismic Criteria and W sheet — TBD once cell refs confirmed
# Will be added after cell references are confirmed
...
# Leave app/wb open — VERT will use the same Excel instance via path
# xlwings will re-attach when VERT opens it
wb.close()
app.quit()
